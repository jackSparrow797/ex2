...
$arNavigation = CDBResult::GetNavParams($arNavParams); // ex2-83_70

if ($this->startResultCache(false, array($arNavigation)/* ex2-83_70 */)) 
{
    if (!Loader::includeModule("iblock")) 
    {
    ...
    $news = \CIBlockElement::GetList(
        ...
        false,
        array("nPageSize" => $arParams['COUNT_ELS']), // ex2-83_70
    ...
    $arResult["NAV_STRING"] = $news->GetPageNavString("Странички"); // ex2-83_70
