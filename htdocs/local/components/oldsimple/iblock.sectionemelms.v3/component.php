...
if(isset($_REQUEST["filtr2"]))
{
	$this->AbortResultCache();
	$count_filter++;
	$arParams["FILTER"][] = array("<PROPERTY_PRICE" => 8000, "PROPERTY_MATERIAL" => "Кожа, ткань");
}
if($count_filter > 1)
{
...
if ($this->startResultCache(false, array($arParams["FILTER"]))) 
{
	...
	$db_sec_list = CIBlockSection::GetList($arSort_section, $arFilter_section, false, false, false);
