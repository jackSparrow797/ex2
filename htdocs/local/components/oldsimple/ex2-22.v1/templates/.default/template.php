...
<form name="filtr" method="get">
 <p><input type="checkbox" name="filtr1" value="OK">Показать товары с ценой больше или равной 1500 и артикулом, начинающимся на «234»
...
foreach($arResult["SECTIONS"] as $arSection)
{
	...
	if(isset($arSection["ELEMENTS"]))
	{
		...
		foreach($arSection["ELEMENTS"] as $product)
		{
			...
			$elem .= "<li id='".$product["ID"]."'>".$product["NAME"]." - ".$product["PROPERTY_PRICE_VALUE"]." - ".$product["PROPERTY_MATERIAL_VALUE"]." - ".$product[$arResult["PROP_ARTICLE_CODE"]."_VALUE"]."</li>";
		}
		$elem .= "</ul>";
	}
