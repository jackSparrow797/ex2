...
?>
<?
//ссылка на станицу exampage? не зависимо от режима работы компонента - ЧПУ/ не ЧУП, должна строится одинаково на основе $arResult, FOLDER и URL_TEMPLATES:
//подставить в нее тестовые значение переменных PARAM 
//$url = ...
