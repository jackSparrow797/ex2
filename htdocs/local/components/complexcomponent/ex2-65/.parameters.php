	...
	"PARAMETERS" => array(
		...
		"SEF_MODE" => Array(
			...
			"exampage" => array(
					...
					"DEFAULT" => "#SECTION_ID#/#ELEMENT_ID#/exam/#PARAM2#/",
					//"DEFAULT" => "#PARAM1#exam.php?PARAM2=#PARAM2#",
					//"DEFAULT" => "/yes/ee/#PARAM2#/#PARAM2#/#PARAM3#/",
					//"VARIABLES" => array("PARAM1", "PARAM2",  "PARAM3", "PARAM4"),
			),
		),
		"IBLOCK_TYPE" => array(
			"PARENT" => "BASE",
