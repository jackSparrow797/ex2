...
$arDefaultUrlTemplates404 = array(
    ...
    "exampage" => "exam/new/#PARAM1#/" // Добавили параметр
);
$arDefaultVariableAliases404 = array(
    "exampage" => array("PARAM2") // Видоизменили
);
...
if($arParams["SEF_MODE"] == "Y"){
	...
	elseif(isset($arVariables["PARAM1"]) && isset($arVariables["PARAM2"]))  // Добавили
		$componentPage = "exampage"; // Добавили
